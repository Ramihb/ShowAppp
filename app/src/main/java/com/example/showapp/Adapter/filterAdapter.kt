...
class filterAdapter(private val userArticleList: List<Article>, private val listener: OnItemClickListener, val context: Context) :
...
//                builder.show()
    ...
    override fun getItemCount(): Int {
        Log.i("nombre du tableau filtre : ", userArticleList.size.toString())
