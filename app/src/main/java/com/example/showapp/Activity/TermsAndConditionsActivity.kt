...
class TermsAndConditionsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var termsCheckBox = findViewById<CheckBox>(R.id.termsCheckBox)
        ...
        TermsAndConditions.text = "TERMS AND CONDITIONS\n" +
                ...
                "-  PayPal\n" +
                "\n" +
                "You agree to provide current, complete, and accurate purchase and account information for all purchases of the Marketplace Offerings made via the Site. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in TND.\n" +
                "\n" +
                ...
                "18. GOVERNING LAW\n" +
                "\n" +
                "These terms shall be governed by and defined following the laws of Tunisia. Showapp and yourself irrevocably consent that the courts of Tunisia shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.\n" +
                "\n" +
                "\n" +
                "19. DISPUTE RESOLUTION\n" +
                "\n" +
                ...
                "Binding Arbitration\n" +
                "\n" +
                "Any dispute arising out of or in connection with this contract, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146)  according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be one (1). The seat, or legal place, of arbitration shall be sfax, Tunisia. The language of the proceedings shall be Arabic English French . The governing law of the contract shall be the substantive law of Tunisia.  \n" +
                "\n" +
                "Restrictions\n" +
                "\n" +
                ...
                "Tunisia\n" +
                "Phone: __________\n" +
                "showapp.application@gmail.com"
        termsCheckBox.setOnCheckedChangeListener { checkBox, isChecked ->
           if (isChecked) {
               check = "true"
           } else {
               check = "false"
        ...
        btnContinue.setOnClickListener {
            if(check == "true"){
                ...
                showSnackbar("you must accept the terms and conditions")
            }
    ...
    private fun showSnackbar(msg: String) {
        Snackbar.make(TermsAndCdts, msg, Snackbar.LENGTH_SHORT).show()
    }
}